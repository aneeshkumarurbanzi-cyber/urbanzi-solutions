  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-black/40 backdrop-blur-lg border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        {/* Logo */}
        <div className="text-white text-lg md:text-xl font-semibold leading-tight">
      ...
      {/* MOBILE MENU */}
      <div className={`fixed top-0 left-0 w-full h-screen bg-[#0b1220] transform transition-transform duration-300 md:hidden ${open ? "translate-x-0" : "-translate-x-full"}`}>
